...
---@field custom_animation fun(unit:any, animationTagPath:any, animationName:string, interpolate:any): boolean Starts a custom animation playing on a unit (interpolates into animation if last parameter is TRUE). Usage: hsc.custom_animation(unitNameOnScenario, my/animation/tag, animationNameInsideTag, "true/false")
...
---@field garbage_collect_now fun(): void
...
---@field help fun(arg1:string): void
---@field hud_blink_health fun(arg1:boolean): void
---@field hud_blink_motion_sensor fun(arg1:boolean): void
---@field hud_blink_shield fun(arg1:boolean): void
---@field hud_clear_messages fun(): void
---@field hud_get_timer_ticks fun(): number
---@field hud_help_flash_restart fun(): void
---@field hud_set_help_text fun(arg1:any): void
---@field hud_set_objective_text fun(arg1:any): void
---@field hud_set_timer_position fun(arg1:number, arg2:number, arg3:any): void
---@field hud_set_timer_time fun(arg1:number, arg2:number): void
---@field hud_set_timer_warning_time fun(arg1:number, arg2:number): void
---@field hud_show_crosshair fun(arg1:boolean): void
---@field hud_show_health fun(arg1:boolean): void
---@field hud_show_motion_sensor fun(arg1:boolean): void
---@field hud_show_shield fun(arg1:boolean): void
...
---@field object_create_anew fun(objectName:string): void Creates an object, destroying it first if it already exists.
...
---@field object_set_scale fun(arg1:any, arg2:number, arg3:number): void
---@field object_set_shield fun(arg1:any, arg2:number): void
---@field object_teleport fun(arg1:any, arg2:any): void
---@field object_type_predict fun(arg1:any): void
---@field objects_attach fun(arg1:any, arg2:string, arg3:any, arg4:string): void
...
---@field objects_detach fun(arg1:any, arg2:any): void
