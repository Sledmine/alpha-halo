...
function hsc.ai:behaviour(behaviour, targetEncounter, boolean)
...
--- Get the living count of AI in a specific encounter. Must use a global short that you declared in <yourmap>.hsc. Globals MUST be lower case.
