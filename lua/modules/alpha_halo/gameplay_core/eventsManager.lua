...
local randomEventTimer = 30 --3600
local randomEventCountdown = randomEventTimer
function eventsManager.randomEventTimer()
    if bansheeLivingCount == 0 or mortarLivingCount == 0 or snipersLivingCount == 0 then
...
function eventsManager.randomEventGenerator()
    local selectedEvent = math.random(1, 3)
...
function eventsManager.aiCheck()
    ...
    hsc.aiAction(1, "Covenant_Banshees")
