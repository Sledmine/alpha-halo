...
unitDeployer.covenantFireteams = {
    startingSquad = {
        name = "Starting Squad",
        random = false,
        unit0 = grunt.majorNdlr.handle.value,
        unit1 = grunt.majorPP.handle.value,
        unit2 = grunt.minorNdlr.handle.value,
        unit3 = grunt.minorNdlr.handle.value,
        unit4 = grunt.minorPP.handle.value,
    ...
    eliteSquad = {
        name = "Elite Squad",
        random = true,
        unit0 = elite.majorNdlr.handle.value,
        unit1 = elite.majorPR.handle.value,
        unit2 = elite.minorNdlr.handle.value,
        unit3 = elite.minorPR.handle.value,
    ...
    stealthSquad = {
        name = "Stealth Squad",
        random = true,
        unit0 = elite.stealthES.handle.value,
        unit1 = elite.stealthES.handle.value,
        unit2 = elite.stealthPR.handle.value,
    ...
    gruntSquad = {
        name = "Grunt Squad",
        random = true,
        unit0 = grunt.heavyFR.handle.value,
        unit1 = grunt.heavyFR.handle.value,
        unit2 = grunt.majorNdlr.handle.value,
        unit3 = grunt.majorPP.handle.value,
    ...
    jackalSquad = {
        name = "Jackal Squad",
        random = true,
        unit0 = jackal.scoutCarbine.handle.value,
        unit1 = jackal.scoutCarbine.handle.value,
        unit2 = jackal.majorPP.handle.value,
        unit3 = jackal.majorPP.handle.value,
        unit4 = jackal.minorPP.handle.value,
    ...
    hunterSquad = {
        name = "Hunter Squad",
        random = true,
        unit0 = hunter.hunter.handle.value,
    ...
    specOpsSquad = {
        name = "Spec Ops Squad",
        random = false,
        unit0 = elite.specOpsNdlr.handle.value,
        unit1 = elite.specOpsPR.handle.value,
        unit2 = elite.specOpsPR.handle.value,
        unit3 = grunt.specOpsFR.handle.value,
        unit4 = grunt.specOpsNdlr.handle.value,
    ...
    zealotSquad = {
        name = "Zealot Squad",
        random = false,
        unit0 = elite.zealotES.handle.value,
        unit1 = elite.zealotES.handle.value,
        unit2 = elite.zealotPC.handle.value,
...
unitDeployer.floodFireteams = {
    startingSquad = {
        name = "Starting Squad",
        random = false,
        unit0 = floodHuman.humanPR.handle.value,
        unit1 = floodHuman.humanPR.handle.value,
        unit2 = floodHuman.humanNdlr.handle.value,
    ...
    humanFlame = {
        ...
        random = true,
        unit0 = floodHuman.armoredFT.handle.value,
        unit1 = floodHuman.armoredFT.handle.value,
        unit2 = floodHuman.humanSS.handle.value,
    ...
    humanSniper = {
        ...
        random = true,
        unit0 = floodHuman.armoredSR.handle.value,
        unit1 = floodHuman.armoredSR.handle.value,
        unit2 = floodHuman.humanBR.handle.value,
    ...
    humanRocket = {
        ...
        random = true,
        unit0 = floodHuman.armoredRL.handle.value,
        unit1 = floodHuman.armoredRL.handle.value,
        unit2 = floodHuman.humanUnarm.handle.value,
    ...
    eliteSquad = {
        name = "Elite Squad",
        random = true,
        unit0 = floodElite.minorAR.handle.value,
        unit1 = floodElite.minorAR.handle.value,
        unit2 = floodElite.minorAR.handle.value,
        unit3 = floodElite.minorAR.handle.value,
        unit4 = floodElite.minorSG.handle.value,
        unit5 = floodElite.minorSG.handle.value,
        unit6 = floodElite.majorAR.handle.value,
        unit7 = floodElite.majorSG.handle.value,
    },
    stealthSquad = {
        name = "Stealth Squad",
        random = true,
        unit0 = floodElite.stealthES.handle.value,
        unit1 = floodElite.stealthES.handle.value,
        unit2 = floodElite.stealthUnarm.handle.value,
    ...
    carrierSquad = {
        ...
        unit2 = floodHuman.humanNdlr.handle.value,
        unit3 = floodHuman.humanNdlr.handle.value,
        unit4 = carrier.carrier.handle.value,
    ...
    specOpsSquad = {
        name = "Spec Ops Squad",
        random = false,
        unit0 = floodElite.specOpsNdlr.handle.value,
        unit1 = floodElite.specOpsNdlr.handle.value,
        unit2 = floodElite.specOpsPR.handle.value,
        unit3 = floodElite.specOpsPR.handle.value,
        unit4 = floodHuman.odstSG.handle.value,
    ...
    zealotSquad = {
        name = "Zealot Squad",
        random = false,
        unit0 = floodElite.zealotES.handle.value,
        unit1 = floodElite.zealotES.handle.value,
        unit2 = floodElite.zealotRL.handle.value,
...
unitDeployer.humanFireteams = {
    odstSquad = {
        name = "ODST Squad",
        random = false,
        unit0 = odst.sniper.handle.value,
        unit1 = odst.sniper.handle.value,
        unit2 = odst.shotgun.handle.value,
...
unitDeployer.sentinelFireteams = {
    sentinelSquad = {
        name = "Sentinel Squad",
        random = false,
        unit0 = sentinel.shieldedMajor.handle.value,
        unit1 = sentinel.shieldedMajor.handle.value,
        unit2 = sentinel.sentinel.handle.value,
...
function unitDeployer.squadAssembler()
    ...
    actorsPalette.elements[0].reference.tagHandle.value = selectedTeam.unit0
    actorsPalette.elements[1].reference.tagHandle.value = selectedTeam.unit1
    actorsPalette.elements[2].reference.tagHandle.value = selectedTeam.unit2
    actorsPalette.elements[3].reference.tagHandle.value = selectedTeam.unit3
    actorsPalette.elements[4].reference.tagHandle.value = selectedTeam.unit4
    actorsPalette.elements[5].reference.tagHandle.value = selectedTeam.unit5
    actorsPalette.elements[6].reference.tagHandle.value = selectedTeam.unit6
    actorsPalette.elements[7].reference.tagHandle.value = selectedTeam.unit7
    -- A better way to do this?
    --for i = 1, actorsPalette.count do
    --    local element = actorsPalette.elements[i]
    --    element.reference.tagHandle.value = selectedTeam["unit" .. i]
    --end
